...
class Brand(db.Model):
    ...
    brand_id = db.Column(db.Integer, primary_key=True, autoincrement=True, nullable=False)
    name = db.Column(db.String(60), nullable=False)
    founded = db.Column(db.Integer, nullable=True)
    headquarters = db.Column(db.String(40), nullable=True)
    discontinued = db.Column(db.Integer, nullable=True)

    dept = db.relationship('Model')
